...
public class EnchantConfig {
    ...
    public static class Common {
        ...
        public final ModConfigSpec.ConfigValue<List<? extends String>> enchantOnSpawnExclusionMobs;
        public final ModConfigSpec.ConfigValue<List<? extends String>> alwayEnchantableMobs;
        public final ModConfigSpec.ConfigValue<List<? extends String>> alwayEnchantableAncientMobs;
        public final ModConfigSpec.ConfigValue<List<? extends String>> disableEnchants;

        public final ModConfigSpec.ConfigValue<List<? extends String>> allowPoisonCloudProjectile;

        public final ModConfigSpec.ConfigValue<List<? extends String>> allowMultishotProjectile;

        public final ModConfigSpec.ConfigValue<List<? extends String>> whitelistShootEntity;
        public final ModConfigSpec.ConfigValue<List<? extends String>> blacklistPlayerEnchant;
